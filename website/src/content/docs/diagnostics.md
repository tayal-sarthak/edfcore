...
| dates and identification | `DATE_CLIPPED_TO_1985_2084`, `DATE_FIELDS_DISAGREE`, `DATE_UNPARSEABLE`, `STARTTIME_UNPARSEABLE`, `PATIENT_ID_NONCONFORMANT`, `RECORDING_ID_NONCONFORMANT` |
